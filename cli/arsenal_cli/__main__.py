...
def build_parser() -> argparse.ArgumentParser:
    ...
    ar_presence = ar.add_mutually_exclusive_group()
    ar_presence.add_argument("--installed", action="store_true", help="only weapons whose tool is on this image")
    ar_presence.add_argument("--missing", action="store_true", help="only weapons whose tool is not installed")
